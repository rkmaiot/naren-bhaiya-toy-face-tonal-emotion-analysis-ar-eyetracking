...
while True:
    _, frame = cap.read()
    #_, frame = cv2.QueryFrame(capture)
    ...
    for face in faces:
        ...
        if(Frame_count>25):
            ...
            if(Move_x >15 or Move_y > 15):
                cv2.putText(frame, "You are getting distracted. Try to focus now.", (150, 50), font, 1, (0, 0, 255),2)
        ...
        for pix_val in Pixell_xy:
            image = cv2.circle(frame, (landmarks.part(pix_val).x, landmarks.part(pix_val).y), 1, (0, 0, 255), 2)
